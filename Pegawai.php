        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
				...
				<!--- tambah data -->
			<form class="form-horizontal" action="add_pegawai.php" method="post">
			<div class="form-group col-md-6">
			  ...
			  <div class="form-group col-md-6">
				  ...
				  <input type="text" class="form-control" name="tlpn_pegawai" placeholder="TLPN_PEGAWAI">
				</div>				
        <div class="form-group col-md-6">
				  <label for="">ALAMAT_PEGAWAI</label>
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <?php 
		include 'koneksi.php';
		$stid = oci_parse($koneksi, 'SELECT * from pegawai');
			...
			?>
                        <tr>                          
						  ...
						  <a href="pegawai_update.php?id=<?= $d['ID_PEGAWAI'] ?>">
							...
							<a href="delete_pegawai.php?id=<?= $d['ID_PEGAWAI'] ?>" 
