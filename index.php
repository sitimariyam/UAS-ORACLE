<?php 
include("koneksi.php");
$stid = oci_parse($koneksi, 'select count(*) as JUM from pegawai');
oci_execute($stid);
              ...
              <div class="card card-stats">
               ...
               <h3 class="card-title"><?php echo $total2['JUM'];?>
                ...
                <div class="card-footer">
				  ...
				  <?php 
				include("koneksi.php");
				$stid = oci_parse($koneksi, 'select count(*) as JUM from menu');
				oci_execute($stid);
				$total2 = oci_fetch_array($stid,OCI_BOTH);
			?>
			<div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
               ...
               <h3 class="card-title"><?php echo $total2['JUM'];?>
                ...
                <div class="card-footer">
				  ...
				  <?php 
				include("koneksi.php");
				$stid = oci_parse($koneksi, 'select count(*) as JUM from pesanan');
				oci_execute($stid);
				$total2 = oci_fetch_array($stid,OCI_BOTH);
			?>
				<div class="col-lg-3 col-md-6 col-sm-6">
