      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
			...
			<!--- tambah data -->
			<form class="form-horizontal" action="add_pembeli.php" method="post">
			<div class="form-group col-md-6">
				  <label for="">ID_PEMBELI</label>
        ...
        <div class="form-group col-md-6">
				  ...
				  <input type="text" class="form-control" name="tlpn_pembeli" placeholder="TLPN_PEMBELI">
				</div>
		...
		while (($d = oci_fetch_array ($stid, OCI_BOTH)) != false) {
			?>
                        <tr>                          
						  ...
						  <td>
                            <?php echo $d['TLPN_PEMBELI']; ?>
                          </td>
						  
						  
                          
                          <td class="td-actions">
						  <a href="pembeli_update.php?id=<?= $d['ID_PEMBELI'] ?>">
                            <button type="button" rel="tooltip" class="btn btn-success">
                              <i class="material-icons">edit</i>
                            </button></a>
							<a href="delete_pembeli.php?id=<?= $d['ID_PEMBELI'] ?>" 
