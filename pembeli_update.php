  ...
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <div class="content">
          ...
          <div class="row">
			...
			<?php
				...
				if (isset($_GET['id'])) {
				  ...
				  $stid = oci_parse($koneksi,"SELECT * FROM PEMBELI WHERE ID_PEMBELI = '$id'");
				  oci_execute($stid);
				 while (($d = oci_fetch_array($stid, OCI_BOTH)) != false) {
				  ?>
			<form class="form-horizontal" action="proses_update_pembeli.php" method="post">
			 <div class="form-row">
				...
				<div class="form-group col-md-6">
				  ...
				  <input type="text" class="form-control" name="id_pegawai" value="<?= $d['ID_PEGAWAI'] ?>">
				</div>
			  </div>
			  <div class="form-row">
			  <div class="form-group col-md-6">
        ...
        <div class="form-row">
			  <div class="form-group col-md-6">
				  <label for="">TLPN_PEMBELI</label>
				  <input type="text" class="form-control" name="tlpn_pembeli" value="<?= $d['TLPN_PEMBELI'] ?>">
				</div>				
			  </div>
