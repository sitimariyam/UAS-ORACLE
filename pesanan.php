      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
			...
			<!--- tambah data -->
			<form class="form-horizontal" action="add_pesanan.php" method="post">
			<div class="form-group col-md-6">
				  <label for="">ID_PESANAN</label>
				  <input type="text" class="form-control" name="id_pesanan" placeholder="ID_PESANAN">
				</div>
				<div class="form-group col-md-6">
				  <label for="">NAMA_MENU_PESANAN</label>
				  <input type="text" class="form-control" name="nama_menu_pesanan" placeholder="NAMA_MENU_PESANAN">
			  </div>
			  <div class="form-row">
			  <div class="form-group col-md-6">
				  <label for="">QTY</label>
		...
		while (($d = oci_fetch_array ($stid, OCI_BOTH)) != false) {
			?>
                        <tr>                          
                          ...
                          <td class="td-actions">
						  <a href="pesanan_update.php?id=<?= $d['ID_PESANAN'] ?>">
                            <button type="button" rel="tooltip" class="btn btn-success">
                              <i class="material-icons">edit</i>
                            </button></a>
							<a href="delete_pesanan.php?id=<?= $d['ID_PESANAN'] ?>" 
