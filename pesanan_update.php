          ...
          <div class="row">
			...
			<?php
				...
				if (isset($_GET['id'])) {
				  ...
				  $stid = oci_parse($koneksi,"SELECT * FROM PESANAN WHERE ID_PESANAN = '$id'");
				  oci_execute($stid);
				 while (($d = oci_fetch_array($stid, OCI_BOTH)) != false) {
				  ?>
			<form class="form-horizontal" action="proses_update_pesanan.php" method="post">
			 <div class="form-row">
				
				
				  <input type="hidden" class="form-control" name="id_pesanan" value="<?= $d['ID_PESANAN'] ?>" >
				
				<div class="form-group col-md-6">
				  <label for="">NAMA_MENU_PESANAN</label>
				  <input type="text" class="form-control" name="nama_menu_pesanan" value="<?= $d['NAMA_MENU_PESANAN'] ?>">
				</div>
			  </div>
			  <div class="form-row">
			  <div class="form-group col-md-6">
